...
namespace PL_Console
{
    public class ConsoleTable
    {
        ...
        public void Write(Format format = PL_Console.Format.Default)
        {
            switch (format)
            {
                case PL_Console.Format.Default:
                    Console.WriteLine(ToString());
                    break;
                case PL_Console.Format.MarkDown:
                    Console.WriteLine(ToMarkDownString());
                    break;
                case PL_Console.Format.Alternative:
                    Console.WriteLine(ToStringAlternative());
                    break;
                case PL_Console.Format.Minimal:
